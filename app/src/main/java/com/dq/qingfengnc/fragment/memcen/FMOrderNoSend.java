...
public class FMOrderNoSend extends BaseFragment implements OrderInterface {
    ...
    public static FMOrderNoSend newInstance(String phone, String token) {
    ...
    public void setUserVisibleHint(boolean isVisibleToUser) {
        ...
        if (isVisibleToUser) {
            orderGetList("1", getArguments().getString("phone"), getArguments().getString("token"));
