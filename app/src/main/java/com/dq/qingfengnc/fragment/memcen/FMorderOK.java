...
public class FMorderOK extends BaseFragment implements OrderInterface {
    ...
    public static FMorderOK newInstance(String phone, String token) {
        Bundle bundle = new Bundle();
        bundle.putString("phone", phone);
        bundle.putString("token", token);
        FMorderOK fragment = new FMorderOK();
