...
public class PullToRefreshLayout extends LinearLayout {
    ...
    // refresh states 刷新状态
    public final int PULL_TO_REFRESH = 2;
    public final int RELEASE_TO_REFRESH = 3;
    public final int REFRESHING = 4;
    // pull state
    public final int PULL_UP_STATE = 0;
    public final int PULL_DOWN_STATE = 1;
    /**
     * last y
     */
    ...
    public void addHeaderView() {
        // header view
        mHeaderView = mInflater.inflate(R.layout.refresh_head, this, false);
...
//        }
     ...
     */
    @SuppressLint("WrongConstant")
    public void headerPrepareToRefresh(int deltaY) {
     ...
     * @param deltaY ,手指滑动的距离
     */
    public void footerPrepareToRefresh(int deltaY) {
        int newTopMargin = changingHeaderViewTopMargin(deltaY);
     ...
     * @param deltaY
     */
    public int changingHeaderViewTopMargin(int deltaY) {
